...
#training['Profession'] = training['Profession'].replace( np.nan ,'nan_prof')

#test['Profession'] = test['Profession'].replace( np.nan ,'nan_prof')



#University Degree

#training['University Degree'] = training['University Degree'].replace( np.nan ,'nan_degree')
#training['University Degree'] = training['University Degree'].replace( '0' ,'nan_degree')

#test['University Degree'] = test['University Degree'].replace( np.nan ,'nan_degree')
#test['University Degree'] = test['University Degree'].replace( '0' ,'nan_degree')


#hair Color 

#training['Hair Color'] = training['Hair Color'].replace( np.nan ,'nan_hair')
#training['Hair Color'] = training['Hair Color'].replace( '0' ,'nan_hair')
#training['Hair Color'] = training['Hair Color'].replace( 'Unknown' ,'nan_hair')

#test['Hair Color'] = test['Hair Color'].replace( np.nan ,'nan_hair')
#test['Hair Color'] = test['Hair Color'].replace( '0' ,'nan_hair')
#test['Hair Color'] = test['Hair Color'].replace( 'Unknown' ,'nan_hair')
...
df.to_csv("LGB_Final6.csv",index=False)
